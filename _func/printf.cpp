...
void __printf(skope* past, const AstNode* pnode, const vector<CVar>& args)
{
	string output;
	...
	skope tast(past);	// to preserve this->Sig
...
void _printf(skope* past, const AstNode* pnode, const vector<CVar>& args)
{
...
#ifndef NO_FILES
//
//void _fprintf(skope* past, const AstNode* pnode)
//{
